...
})({"45PM7":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
var _resumeJs = require("./components/resume.js");
var _resumeJsDefault = parcelHelpers.interopDefault(_resumeJs);
var _skillJs = require("./components/skill.js");
var _skillJsDefault = parcelHelpers.interopDefault(_skillJs);
_resumeJsDefault.default.init();
_skillJsDefault.default.init();
window.onload = function() {
    ...
    window.addEventListener('scroll', ()=>{
        ...
        const sectionPos = [
            ...sectionElem
        ].map((section)=>section.offsetTop + section.offsetHeight - navPos
        );
...
},{"./components/resume.js":"5kMd7","./components/skill.js":"73EJM","@parcel/transformer-js/src/esmodule-helpers.js":"h2BEm"}],"5kMd7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function createContent(title, year) {
    ...
    descriptionElem.textContent = `Masuk tahun ${year.start}, ${year.end ? `Lulus tahun ${year.end}` : 'Sampai sekarang'}`;
    return [
        titleElem,
        descriptionElem
    ];
...
},{}],"73EJM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const skills = [
    {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"h2BEm"}]},["45PM7","8lRBv"], "8lRBv", "parcelRequire8d36")
